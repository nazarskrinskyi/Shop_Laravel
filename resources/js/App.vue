<template>
              ...
              <div class="container">
                <div class="row">
                  <div class="menu-info d-flex justify-content-between align-items-center">
                    ...
                    <a href="index.html" class="logo"> <img src="http://localhost:5173/src/assets/images/logo/logo.png" alt=""> </a>
                    ...
                    <div class=" d-flex align-items-center justify-content-between ">
                      <nav>
                        ...
                        <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                          ...
                          <li class="dropdown-list"><router-link to="/products">Products</router-link></li>

                          <li class="dropdown-list"><a href="/"> <span>Additional</span> <span class="menuarrow"> <i
                      ...
                      <div class="right d-flex align-items-center justify-content-end">
                        <ul class="main-menu__widge-box d-flex align-items-center ">
                          <li class="d-lg-block d-none"><a href="my-account.html"><i class="flaticon-user"></i> </a>
                          </li>
      ...
      <div class="top">
        ...
        <div class="cart_items">
          <div class="items d-flex justify-content-between align-items-center">
            <div class="left d-flex align-items-center"> <a href="shop-details-1.html" class="thumb d-flex justify-content-between align-items-center"> <img src="http://localhost:5173/src/assets/images/shop/products-img1.jpg" alt=""> </a>
          ...
          <div class="items d-flex justify-content-between align-items-center">
            <div class="left d-flex align-items-center"> <a href="shop-details-1.html" class="thumb d-flex justify-content-between align-items-center"> <img src="http://localhost:5173/src/assets/images/shop/products-img2.jpg" alt=""> </a>
              <div class="text"> <a href="shop-details-1.html">
          ...
          <div class="items d-flex justify-content-between align-items-center">
            <div class="left d-flex align-items-center"> <a href="shop-details-1.html" class="thumb d-flex justify-content-between align-items-center"> <img src="http://localhost:5173/src/assets/images/shop/products-img3.jpg" alt=""> </a>
              <div class="text"> <a href="shop-details-1.html">
                <h6>Diamond Ring </h6>
              </a>
          ...
          <div class="items d-flex justify-content-between align-items-center">
            <div class="left d-flex align-items-center"> <a href="shop-details-2.html" class="thumb d-flex justify-content-between align-items-center"> <img src="http://localhost:5173/src/assets/images/shop/products-img4.jpg" alt=""> </a>
              <div class="text"> <a href="shop-details-1.html">
                <h6>Women Earring</h6>
              </a>
                <p>1 X <span>$150.00</span> </p>
              ...
              <div class="form_inner">
                ...
                <form action="index.html" method="post">
                  ...
                  <div class="form-group message-btn mt-4">
                    <button type="submit" class="btn--secondary"><span class="txt">Submit Now</span></button>
                  </div>
                </form>
              </div>
  ...
  <footer class="footer-default footer-3">
    <div class="footer-default__shap_1 position-absolute "><img src="http://localhost:5173/src/assets/images/shape/footer-shape-1.png" alt="">
    </div>
    <!--Start Footer-->
            ...
            <div class="footer-default__single-box">
              ...
              <div class="footer-newsletter">
                ...
                <form action="#0" class="footer-default__subscrib-form">
                  <div class="footer-input-box"><input type="email" placeholder="Email address" name="email">
                ...
                <div class="newsletter-bottom d-flex align-items-center">
                  ...
                  <div class="footer__medio-boxx  medio-boxx  d-flex align-items-center">
                    <ul>
                      ...
                      <li><a href="https://www.instagram.com/"><i class="flaticon-instagram" target="_blank"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
